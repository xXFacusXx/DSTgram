    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (type == 0) {
            ...
            if (i == 2) {
                ...
                actionCell.setTextAndIcon(LocaleController.getString("Personalization", R.string.Personalization), R.drawable.menu_personalization);
            } else if (i == 9) {
                actionCell.setTextAndIcon(LocaleController.getString("Settings", R.string.Settings), R.drawable.menu_settings);
            } else if (i == 10) {
                actionCell.setTextAndIcon(LocaleController.getString("DarkSideTeam", R.string.DarkSideTeam), R.drawable.menu_visit);
            }
        }
