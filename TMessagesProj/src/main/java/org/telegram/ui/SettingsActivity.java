...
public class SettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    public View createView(Context context) {
        ...
        actionBar.setBackgroundColor(preferences.getInt("FondoAvatarSettingsColor", 0xff0c6a8c));
        ...
        nameTextView.setTextColor(preferences.getInt("NickSettingsColor", 0xffffffff));
        ...
        onlineTextView.setTextColor(preferences.getInt("EstadoSettingsColor", 0xffb3e5f7));
