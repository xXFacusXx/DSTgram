...
public class Switch extends CompoundButton {
    ...
    public void setChecked(boolean checked) {
        ...
        if (mTrackDrawable != null) {
            mTrackDrawable.setColorFilter(new PorterDuffColorFilter(checked ? getColorWithAlpha(preferences.getInt("TitulosSettings", 0xff0c6a8c), 0.3f) : 0xffc7c7c7, PorterDuff.Mode.MULTIPLY));
        }
        if (mThumbDrawable != null) {
            mThumbDrawable.setColorFilter(new PorterDuffColorFilter(checked ? preferences.getInt("TitulosSettings", 0xff0c6a8c) : 0xffededed, PorterDuff.Mode.MULTIPLY));
        }
    }

    /**
     * Funcion para obtener el color con cierto alpha
     *
     * @param color
     * @param ratio
     * @return color con el aplha aplicado
     */
