...
public class DialogsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int valorActionbar = 0; // Color del fondo de la actionbar
    public int valorTextoActionBar = 0; // Color del texto de la actionbar
    ...
    public View createView(final Context context) {
        ...
        /*******************************************************************************************
         *******************************************************************************************
         **                              Agregado para la actionbar                               **
         *******************************************************************************************
         *******************************************************************************************/
        ColorPickerActivity colorPickerActivity = new ColorPickerActivity();
        valorActionbar = colorPickerActivity.getValActionBar();
        valorTextoActionBar = colorPickerActivity.getValTextActionBar();
        /********************************************************************************************/
    ...
    public void onResume() {
        ...
        if (actionBar != null && (preferences.getInt("ActionBarColor", 0xff0c6a8c) != valorActionbar || preferences.getInt("TituloPrincipalColor", 0xffffffff) != valorTextoActionBar)) {
            if (preferences.getInt("ActionBarColor", 0xff0c6a8c) != valorActionbar && preferences.getInt("TituloPrincipalColor", 0xffffffff) != valorTextoActionBar) {
            ...
            } else if (preferences.getInt("ActionBarColor", 0xff0c6a8c) != valorActionbar){
                actionBar.setBackgroundColor(preferences.getInt("ActionBarColor", 0xff0c6a8c));
            } else if (preferences.getInt("TituloPrincipalColor", 0xffffffff) != valorTextoActionBar) {
                actionBar.setColorTexto(preferences.getInt("TituloPrincipalColor", 0xffffffff));
            }
        }
    }
